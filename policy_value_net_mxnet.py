...
class PolicyValueNet_SelfPlay():
    def __init__(self, gpuid, board_width, board_height, model_params=None):
        #logging.info('PolicyValueNet_SelfPlay__init__......0')
        self.context_p = mx.gpu(gpuid)
        self.channelnum = 4
...
class PolicyValueNet():
    ...
    def __init__(self, gpuid, batchsize, board_width, board_height, model_params=None):
        self.context = mx.gpu(gpuid)
